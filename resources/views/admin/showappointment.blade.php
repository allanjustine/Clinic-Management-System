                    ...
                    <form action="/showappointment" method="GET">
                        <div class="d-flex">
                            <input type="text" name="search" class="form-control" id="search"
                                placeholder="Search user..." value="{{ $searchQ }}">
                ...
                <div align="center" style="padding-top:50px;">
                    <table class="table">
                        ...
                        @forelse ($usersWithAppointments as $appoint)
                            <tr align="center">
                                <td> <img
                                        @if ($appoint->profile_photo_path == null) src="userimage/temp-user.jpg"
                                @else
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('patients-details', $appoint->id) }}" class="btn btn-info"><span
                                            class="mdi mdi-eye"></span> View</a>
